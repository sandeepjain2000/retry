...
def find_and_click_retry():
    ...
    # --- Save debug screenshot so you can see what's being captured ---
    cv2.imwrite("debug_full.png", screenshot_cv)

    # Strategy 1: detect blue button pixels (both Retry and Accept All are blue)
    ...
    for i, word in enumerate(words):
        # Check single word targets: "retry", "accept"
        ...
        if matched and int(data['conf'][i]) > 30:
            ...
            # If matched "accept", check if next word is "all" to expand bounding box
